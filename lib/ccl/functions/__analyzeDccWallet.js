                    ...
                    if: [
                      {
                        or: [
                          {
                            and: [
                              { var: 'allRelevantVCsAndRCsAnnotatedWithContext.0.__isVC' },
                              { var: 'allRelevantVCsAndRCsAnnotatedWithContext.0.__isBooster' },
                              {
                                or: [
                                  { var: 'allRelevantVCsAndRCsAnnotatedWithContext.0.__hasSomePreviousVaccination' },
                                  { var: 'allRelevantVCsAndRCsAnnotatedWithContext.0.__hasPreviousRC' },
                                  { var: 'allRelevantVCsAndRCsAnnotatedWithContext.0.__isDnAboveSd' }
                                ]
                              }
                            ]
                          },
                          {
                            and: [
                              { var: 'allRelevantVCsAndRCsAnnotatedWithContext.0.__isRC' },
                              { var: 'allRelevantVCsAndRCsAnnotatedWithContext.0.__isAlreadyValid' },
                              { var: 'allRelevantVCsAndRCsAnnotatedWithContext.0.__hasSomePreviousVaccination' },
                              {
                                '!': [
                                  { var: 'allRelevantVCsAndRCsAnnotatedWithContext.0.__hasPreviousPartialVaccination' }
                                ]
                              }
                            ]
                          }
