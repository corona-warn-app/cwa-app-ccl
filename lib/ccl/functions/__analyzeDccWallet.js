...
const descriptor = {
  ...
  definition: {
    ...
    logic: [
                    ...
                    map: [
                      { var: 'annotated' },
                      {
                        script: [
                          {
                            assign: [
                              'it.__hasPreviousFullImmunization',
                              {
                                some: [
                                  { var: 'annotated' },
                                  {
                ...
                declare: [
                  'resorted',
                  {
                    call: [
                      '__sortCertificatesByDate',
                      {
                        certificates: { var: 'annotatedWithPrevious' },
                        ascending: false
                      }
                    ]
                  }
      ...
      {
        declare: [
          'allTCsWithValidPCRForMaskState',
          {
            filter: [
              { var: 'allTCsWithValidPCR' },
              {
                'not-after': [
                  { var: 'now.utcDateTime' },
                  {
                    plusTime: [
                      { var: 'it.hcert.t.0.sc' },
                      // assumes that TC_PCR_VALIDITY_IN_HOURS_FOR_MASK_STATE is shorter than TC_PCR_VALIDITY_IN_HOURS
                      constants.TC_PCR_VALIDITY_IN_HOURS_FOR_MASK_STATE,
                      'hour'
                    ]
                  }
                ]
      ...
      {
        declare: [
          'allTCsWithValidRATForMaskState',
          {
            filter: [
              { var: 'allTCsWithValidRAT' },
              {
                'not-after': [
                  { var: 'now.utcDateTime' },
                  {
                    plusTime: [
                      { var: 'it.hcert.t.0.sc' },
                      // assumes that TC_RAT_VALIDITY_IN_HOURS_FOR_MASK_STATE is shorter than TC_RAT_VALIDITY_IN_HOURS
                      constants.TC_RAT_VALIDITY_IN_HOURS_FOR_MASK_STATE,
                      'hour'
                    ]
                  }
                ]
      ...
      // mask state
      {
        declare: [
          ...
          {
            '!!': [
              { var: 'allTCsWithValidPCRForMaskState' }
            ]
          }
        ]
      },
      ...
      {
        declare: [
          'maskState_hasValidRC',
          {
            and: [
              { var: 'allLegitimateRCs' },
              {
                '<=': [
                  {
                    diffTime: [
                      { var: 'now.localDate' },
                      { var: 'allLegitimateRCs.0.hcert.r.0.fr' },
                      'day'
                    ]
                  },
                  90
        ...
        declare: [
          'maskState_VCAfterRC',
          {
            and: [
              ...
              {
                '<=': [
                  { var: 'mostRecentVaccinationCertificate.__ageInDays' },
                  90
                ]
              },
              {
                ...
                if: [
                  {
                    and: [
                      {
                        '===': [
                          { var: 'mostRecentVaccinationCertificate.hcert.v.0.dn' },
                          2
                        ]
                      },
                      {
                        '===': [
                          { var: 'mostRecentVaccinationCertificate.hcert.v.0.sd' },
                          1
                        ]
                      }
                    ]
                  ...
                  // then
                  { var: 'mostRecentVaccinationCertificate.__hasPreviousRC' },
                  // else
                  true
                ]
              }
