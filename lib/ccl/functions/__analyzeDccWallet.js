                          ...
                          },
                          {
                            assign: [
                              'it.__isWHOApproved',
                              {
                                in: [
                                  { var: 'it.hcert.v.0.mp' },
                                  constants.VC_MP_SET_WHO_APPROVED
                                ]
                              }
                            ]
                          },
                          {
                            assign: [
                              'it.__isDEApproved',
                              {
                                in: [
                                  { var: 'it.hcert.v.0.mp' },
                                  constants.VC_MP_SET_DE_APPROVED
                                ]
                              }
                            ]
                          },
            ...
            if: [
                ...
                or: [
                  {
                    and: [
                      ...
                      {
                        or: [
                          { var: 'mostRecentVaccinationCertificate.__isDEApproved' },
                          {
                            and: [
                              { var: 'mostRecentVaccinationCertificate.__isWHOApproved' },
                              { var: 'mostRecentVaccinationCertificate.__hasPreviousMRNA' }
                            ]
                          }
                        ]
                      }
              ...
              // else if
              {
                and: [
                  ...
                  {
                    or: [
                      { var: 'mostRecent2GCertificate.__isDEApproved' },
                      {
                        and: [
                          { var: 'mostRecent2GCertificate.__isWHOApproved' },
                          { var: 'mostRecent2GCertificate.__hasPreviousMRNA' }
                        ]
                      }
                    ]
                  }
