                    ...
                    map: [
                      { var: 'sorted' },
                      {
                        script: [
                          ...
                          {
                            assign: [
                              'it.__isVaccineApproved',
                              {
                                or: [
                                  { var: 'it.__isDEApproved' },
                                  {
                                    and: [
                                      { var: 'it.__isWHOApproved' },
                                      { var: 'it.__hasPreviousMRNA' }
                                    ]
                                  }
                                ]
                              }
            ...
            if: [
                ...
                or: [
                  {
                    and: [
                      ...
                      { var: 'mostRecentVaccinationCertificate.__isVaccineApproved' }
                    ]
                  },
                  {
                    and: [
              ...
              // else if
              {
                and: [
                  ...
                  { var: 'mostRecent2GCertificate.__isVaccineApproved' }
                ]
              },
              'COMPLETE_IMMUNIZATION_RC',
              // else
