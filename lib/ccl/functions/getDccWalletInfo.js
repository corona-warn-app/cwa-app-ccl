        ...
        declare: [
          'validUntil',
          {
            script: [
              ...
              {
                if: [
                  { var: 'walletAnalysis.__allTCsWithValidRAT.0' },
                  {
                    assign: [
                      'dates',
                      {
                        push: [
                          ...
                          {
                            plusTime: [
                              { var: 'walletAnalysis.__allTCsWithValidRAT.0.hcert.t.0.sc' },
                              2,
                              'day'
                            ]
                          }
              ...
              {
                if: [
                  { var: 'walletAnalysis.__allTCsWithValidPCR.0' },
                  {
                    assign: [
                      'dates',
                      {
                        push: [
                          ...
                          {
                            plusTime: [
                              { var: 'walletAnalysis.__allTCsWithValidPCR.0.hcert.t.0.sc' },
                              3,
                              'day'
                            ]
                          }
